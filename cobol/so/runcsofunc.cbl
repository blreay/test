...
*     * ========================================================  
       display "*********************************"
       display "ENTER runcsofunc"

       display "runcsofunc...MY C PROGRAM BEGIN :"                                         
       move "libuser_dyn_main1"        to programme-name                     
       call programme-name using cmd-line returning status-code.    
       display "runcsofunc...MY C PROGRAM END :"           

       display "runcsofunc...MY C PROGRAM BEGIN connect DB :"                                         
       move "libuser_dyn_main2"        to programme-name
       call programme-name using cmd-line returning status-code.    
       display "runcsofunc...MY C PROGRAM END :"              display "RUNB END :"                                           

       display "EXIT runcsofunc"
       EXIT.

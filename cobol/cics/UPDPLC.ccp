      ...
      *   SCREEN.                                                   *
      ***************************************************************
	        DISPLAY "UPDPLC: zzy begin 200-SCREEN-RECEIVE SECTION".
      ...
      ***************************************************************
	       DISPLAY "UPDPLC: zzy begin 300-ALLOCATE-COMMAREA SECTION".
      ...
      ***************************************************************
            ...
            PERFORM VARYING IX FROM 1 BY 1
	            ...
	            DISPLAY "UPDPLC: zzy in perform IX=" IX
	            DISPLAY "UPDPLC: zzy in perform SCREEN-TRAN(2 : 1)=" SCREEN-TRAN(2 : 1)
      ...
      *  IF THE TRANSACTION WAS H1PL PERFORM SYNCONRETURN
                        EXEC CICS LINK
                            ...
                            RESP(RESP-CODE)
                        END-EXEC
	                    DISPLAY "UPDPLC: zzy after cics link1" 
						          REMOTE-SYSID
      ...
      *  IF THE TRANSACTION WAS H2PL PERFORM FULL SYNCLEVEL
                        EXEC CICS LINK
                            ...
                            RESP(RESP-CODE)
                        END-EXEC
	                    DISPLAY "UPDPLC: zzy after cics link2"

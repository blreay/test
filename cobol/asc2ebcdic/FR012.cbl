...
*     *@ (c) Oracle:convert-buffer-zos-to-linux.pgm. $Revision: 1.10 $
*     *Version with ZoneGroupe for numeric (display/packed) fields
      ...
      * Since display number needs to be converted before
      * it is used as rule, move from char type to
      * another char type is necessary to keep the value
      * correct.
...
$set sourceformat"fixed"
      ...
      *  Process for conversion.
       MOVE-BINARY-VALUES-TO-COBOL.
           ...
           CALL 'art_e2a' using  X-D-DATA01,
                                      BY VALUE REC-LENGTH

           MOVE 4 TO REC-LENGTH
           CALL 'art_e2a' using  D-DATA02,
                                      BY VALUE REC-LENGTH

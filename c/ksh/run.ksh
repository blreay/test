	...
	case "${buildmode}" in
		*.linux.*)
			...
			case "${buildmode}" in
				...
				*.gcc.c99*)	bgcc_frontend='gcc'    bgcc_stdlangmode='-std=gnu99 -D_GNU_SOURCE=1' bextra_warnings='-fstrict-aliasing -Wstrict-aliasing -fstrict-overflow -Wstrict-overflow -Wsequence-point -Wno-parentheses -Wno-unused -Wno-trigraphs -Wuninitialized -Wclobbered -Waddress' ;;
				*.gcc.c1x*)	bgcc_frontend='gcc'    bgcc_stdlangmode='-std=gnu1x -D_GNU_SOURCE=1' bextra_warnings='-fstrict-aliasing -Wstrict-aliasing -fstrict-overflow -Wstrict-overflow -Wsequence-point -Wno-parentheses -Wno-unused -Wno-trigraphs -Wuninitialized -Wclobbered -Waddress' ;;
